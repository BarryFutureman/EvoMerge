...
def randomly_sample_winogrande(dataset_dir, sample_size):
    builder = Winogrande(config_name="winogrande_xl")
    ...
    # Json Lines format
    output_file = dataset_dir + "/random_winogrande_dataset.jsonl"
...
if __name__ == '__main__':
    randomly_sample_winogrande("C:/Files/PycharmProjects/NeuralEvolution/EvoMerge/runs/random_llamas/datasets", 20)
