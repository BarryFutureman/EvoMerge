from evolution.selection_methods import selection
import random
...
class RouletteWheelSelection(selection.SelectionMethod):
    ...
    def run_selection(self, population, target_population_size):
        ...
        keep_population = sorted_population[:self.config.keep_top_k]
        ...
        pairs = []
        for p in range(target_population_size - self.config.keep_top_k):
